...
which measures the overlap between two quantum states.
  ...
  \ex{Inner Product Example}{
    ...
    \[
      \langle \mathbf{v}, \mathbf{w} \rangle = \begin{bmatrix} 1 & -i \end{bmatrix}
...
\dfn{Outer Product}{The \textbf{outer product} of two vectors $\mathbf{v} \in
  ...
  \[
    ...
    H^\dagger = \begin{bmatrix} a & b - ic \\ b + ic & d \end{bmatrix}
  ...
  \nt{Hermitian matrices are unitary, but unitary matrices are not necessarily
  Hermitian:
  ...
  A quantum state vector $\ket{\psi}$ can be expressed as a linear combination of
  the basis states:
  ...
  \begin{itemize}
    \item The computational basis states are orthogonal:
    \[
      \langle 0 | 1 \rangle = \zero^\dagger \one = \bmatrix 1 & 0 \endbmatrix \bmatrix 0 \\ 1 \endbmatrix = 0
    \]
    \item The computational basis states are normalized:
    \[
      \langle 0 | 0 \rangle = \zero^\dagger \zero = \bmatrix 1 & 0 \endbmatrix \bmatrix 1 \\ 0 \endbmatrix = 1
    \]
  \end{itemize}
  }
