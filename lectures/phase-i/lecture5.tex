...
\dfn{Circuit Diagrams}{Visual representation of quantum operations, with time
flowing left to right.}
\begin{itemize}
    \item Qubits arranged vertically (MSB at top)
    \item Single-qubit gates affect individual lines
    \item Measurement shown with meter symbol
    \item Classical bits shown with double lines
\end{itemize}
