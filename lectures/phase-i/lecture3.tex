...
\dfn{Classical Computing Paradigms}{Quantum computing introduces a
...
\dfn{Bloch Sphere}{A geometric representation of a single qubit state:
  ...
  \begin{itemize}
    ...
    \aside{
      Rearranging the Bloch sphere formula, we obtain that $\theta$ and $\phi$ can be expressed as:
    ...
    \ex{Factoring Out the Global Phase}{
      ...
      \[
        \begin{aligned}
          ...
          & = \underbrace{i}_{\text{global phase}} \lt(\frac{1}{\sqrt{2}}\zero + \frac{1}{\sqrt{2}}\one\rt) \\
        \end{aligned}
      \]
    }
...
\dfn{Quantum Measurement}{When a qubit is measured:
  \begin{itemize}
    ...
    \[ |\psi_{\text{new}}\rangle = \frac{|b\rangle \langle b | \psi
    \rangle}{\sqrt{P(b)}} \]
\end{itemize}}
