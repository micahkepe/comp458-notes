\section{Lecture 20: Quantum Error Correction}\label{sec:lecture20}
...
\index{error correct!classical error detection}
...
\index{error correct!quantum error detection}
...
\index{error correct!repetition code}
\dfn{Repetition Code}{
