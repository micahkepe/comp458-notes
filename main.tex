...
\input{lectures/phase-ii/lecture11.tex}
...
\input{lectures/phase-iii/lecture12.tex}

% ● Introduction to quantum optimization problems
% ● Quantum approximate optimization algorithm (QAOA)
\input{lectures/phase-iii/lecture13.tex}
\input{lectures/phase-iii/lecture14.tex}
\input{lectures/phase-iii/lecture15.tex}
...
\input{lectures/phase-iv/lecture16.tex}

% ● Architectural challenges and constraints in building quantum system
\input{lectures/phase-iv/lecture17.tex}
\input{lectures/phase-iv/lecture18.tex}

% ● More on Logical to Physical Mapping
\input{lectures/phase-iv/lecture19.tex}

% ● Quantum error correction
\input{lectures/phase-iv/lecture20.tex}
\input{lectures/phase-iv/lecture21.tex}
...
% ● Quantum Annealers, Trapped Ion Quantum Computers
\input{lectures/phase-v/lecture22.tex}

% ● Neutral Atom Quantum Computers, Photonic Quantum Computers
\input{lectures/phase-v/lecture23.tex}
